                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, points), { image_url: url + "/uploads/" + point.image });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedPoint = __assign(__assign({}, point), { image_url: url + "/uploads/" + point.image });
                    ...
                    case 2:
                        items = _a.sent();
                        return [2 /*return*/, res.json({ point: serializedPoint, items: items })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        trx = _b.sent();
                        point = { image: req.file.filename, name: name, email: email, whatsapp: whatsapp, latitude: latitude, longitude: longitude, city: city, uf: uf };
